...
#define AREF 3.31         // valeur de reference externe
#define quantum_ADC 0.202 // quantam ADC en mV, depends de Aref. 0.2008056641 = Aref/2**ADC_resolution si Aref = 3.29V
